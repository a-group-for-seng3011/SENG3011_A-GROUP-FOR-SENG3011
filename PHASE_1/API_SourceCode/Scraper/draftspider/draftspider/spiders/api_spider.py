...
class APISpider(scrapy.Spider):
    ...
    def parse_article(self, response):
        ...
        text_dirty = response.xpath('//div[@class="postcontent"]//*[self::p or self::ul or self::h3]//text()[not(parent::script)][not(parent::a/parent::strong)][not(parent::b/parent::strong)][not(parent::a[@href]/parent::*[not(text())])][not(parent::strong/parent::a/parent::*[not(text())])][not(parent::strong/parent::em/parent::a[not(text())])]').getall()
